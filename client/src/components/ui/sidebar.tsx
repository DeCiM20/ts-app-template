...
function Sidebar({
  ...
  return (
    <div data-slot="sidebar" className={cn("bg-sidebar text-sidebar-foreground flex h-full min-h-screen w-(--sidebar-width) flex-col", className)} {...props}>
      {children}
    </div>
  )
}
...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <Menu className="size-6 min-h-6 min-w-6" />
...
const SidebarMenuButton = React.forwardRef<HTMLButtonElement, SidebarMenuButtonProps>(({ asChild = false, isActive = false, variant = "default", size = "default", tooltip, className, ...props }: SidebarMenuButtonProps, ref) => {
  const Comp = asChild ? Slot : "button"
...
const SidebarMenuAction = React.forwardRef<HTMLButtonElement, SidebarMenuActionProps>(({ className, asChild = false, showOnHover = false, ...props }: SidebarMenuActionProps, ref) => {
  const Comp = asChild ? Slot : "button"
